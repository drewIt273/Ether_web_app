...
import {strictObject} from "@assets/any"; import {jsx} from "./ui-root"
...
export const vector = {
    ...
    arrow: {
        upright: jsx('svg', {
            append: [
                jsx('path', {
                    d: 'm4.5 19.5 15-15m0 0H8.25m11.25 0v11.25', ...r11
                })
            ],
            ...v24
        }),
        left: jsx('svg', {
            append: [
                jsx('path', {
                    d: 'M10.5 19.5 3 12m0 0 7.5-7.5M3 12h18', ...r11
                })
            ],
            ...v24
        }),
        right: jsx('svg', {
            append: [
                jsx('path', {
                    d: 'M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3', ...r11
                })
            ],
            ...v24
        })
...
function makeFreshNodes(o: Record<string, any>) {
    for (const [key, value] of Object.entries(o)) {
        if (strictObject(value)) makeFreshNodes(value); // recurse
        else {
            const fn = () => (value as Node).cloneNode(true);
            Object.defineProperty(fn, 'jsx', {
                value: (o: Fiber) => fn().jsx(o),
                enumerable: false,
                configurable: false
            })
            o[key] = fn
